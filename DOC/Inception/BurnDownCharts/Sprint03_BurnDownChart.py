...
if len(sys.argv) < 5:
    ...
    print("> python burndownchart.py validToken 3 7 Mostra")
    sys.exit()
...
TOKEN = sys.argv[1]
SPRINT = check_positive_int(sys.argv[2])
DAYS = check_positive_int(sys.argv[3])
MOSTRA = sys.argv[4] == "Mostra"
...
g = Github(TOKEN)
repo = g.get_repo("alessioarcara/project_sweng")
