...
public class PhysicalCardTest {
    ...
    public void initialize() {
        ...
        pCard = new PhysicalCard(card.getId(), "1 (Very Good)", "well handled card during almost 10 years");
    }

    @Test
    public void testGetCardId_getId() {
        PhysicalCard pCard2 = new PhysicalCard(card.getId(), "2 (Good)", "test description card");
    ...
    public void testGetStatus() {
        Assertions.assertEquals("1 (Very Good)", pCard.getStatus());
    }
