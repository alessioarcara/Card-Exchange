...
public class ExchangeActivity extends AbstractActivity implements NewExchangeView.ExchangePresenter {
    private final ExchangePlace place;
    private final NewExchangeView view;
    private final ExchangeServiceAsync exchangeService;
    private final AuthSubject authSubject;
    private final PlaceController placeController;

    public ExchangeActivity(ExchangePlace place, NewExchangeView view, ExchangeServiceAsync exchangeService, AuthSubject authSubject, PlaceController placeController) {
        this.place = place;
        this.view = view;
